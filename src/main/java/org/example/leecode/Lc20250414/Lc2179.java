...
public class Lc2179 {
    public static void main(String[] args) {
        Lc2179 lc2179 = new Lc2179();
        // System.out.println(lc2179.countGoodTriplets(new int[]{3, 0, 1, 1, 9, 7}, 7, 2, 3));
        System.out.println(lc2179.countGoodTriplets(new int[]{7,3,7,3,12,1,12,2,3}, 5, 8, 1));
    }
